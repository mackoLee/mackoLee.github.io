...
*/
    ...
    ;
    var C = new B("OFF",Infinity), ua = new B("WARNING",900), va = new B("CONFIG",700), wa = function() {
      this.g = 0;
      this.clear()
    }, D;
...
*/
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var Pa = /^(\/[a-zA-Z0-9_\-]+)+$/
      ...
      return [encodeURIComponent(a.pathPrefix).replace(/%2C/g, ",").replace(/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" + e(d) : "", "/rt=j/sv=1/d=1/ed=1", a.j ? "/am=" + e(a.j) : "", a.v ? "/rs=" + e(a.v) : "", a.A ? "/t=" + e(a.A) : "", "/cb=", e(c)].join("")
    }
      , Ya = function(a) {
      ...
      c = 0;
      for (d = Qa.length; c < d; ++c)
        Qa[c].test(b) && W("invalid_prefix");
      c = X(a, "k", !0);
      d = X(a, "am");
      e = X(a, "rs");
      a = X(a, "t");
    ...
    var Y = decodeURI("%73cript"), ab = /^[-+_0-9\/A-Za-z]+={0,2}$/, bb = function(a, b) {
      ...
      var a = R.nonce;
      return void 0 !== a ? a && a === String(a) && a.match(ab) ? a : R.nonce = null : L.querySelector ? (a = L.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "",
        a && a === String(a) && a.match(ab) ? R.nonce = a : R.nonce = null) : null : null
    }, eb = function(a) {
    ...
    window.gapi.load("", {
      ...
      _c: {
        ...
        jsl: {
          ...
          h: "m;/_/scs/abc-static/_/js/k=gapi.lb.ko.nxGZdyl27Ik.O/d=1/rs=AHpOoo90WP5zotylFVocNO9AbJ77XckLKw/m=__features__",
